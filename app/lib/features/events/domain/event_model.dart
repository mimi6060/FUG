...
class EventModel extends Equatable {
  ...
  factory EventModel.fromJson(Map<String, dynamic> json) {
    return EventModel(
      ...
      categoryId: json['category'] as String? ?? 'other',
      categoryName: json['categoryName'] as String?,
      imageUrl: json['imageUrl'] as String?,
      additionalImages: List<String>.from(json['additionalImages'] ?? []),
      address: json['locationAddress'] as String? ?? json['locationName'] as String? ?? '',
      latitude: (json['locationLat'] as num?)?.toDouble() ?? 0.0,
      longitude: (json['locationLng'] as num?)?.toDouble() ?? 0.0,
      venueName: json['locationName'] as String?,
      startDate: DateTime.parse(json['startDate'] as String),
      endDate: json['endDate'] != null ? DateTime.parse(json['endDate'] as String) : DateTime.parse(json['startDate'] as String),
      maxParticipants: json['maxParticipants'] as int?,
      currentParticipants: json['participantCount'] as int? ?? 0,
  ...
  /// Convertit le EventModel en Map JSON (format base de données)
